            ...
            <Col md={6}>
              <form action="#">
                <div className="mb-3">
                  ...
                  <IMaskInput mask="00/00/0000" placeholder="__/__/___" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask="000.000.000.000.000,00" placeholder="#.##0,00" className="form-control" />
            ...
            <Col md={6}>
              <form action="#">
                <div className="mb-3">
                  ...
                  <IMaskInput mask="0000-0000" placeholder="____-____" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask="(00) 0000-0000" placeholder="(__)____-____" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask="000-000-0000" placeholder="(___)___-____" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask="(00) 00000-0000" placeholder="(__)_____-____" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask="000.000.000-00" placeholder="___.___.____-__" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask="00.000.000/0000-00" placeholder="__.___.___/____-__" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask="099.099.099.099" placeholder="___.___.___.___" className="form-control" />
